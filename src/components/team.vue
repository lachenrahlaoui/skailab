                    ...
                    <div class="margin-padding " >
                        ...
                        <div class="team-names">
                            <div class="t-card-body ">
                                ...
                                <p class="t-card-text"> AI and Performance Yahoo! Silicon valley</p>
                            </div>
                        </div>
                    ...
                    <div class="margin-padding " >
                        ...
                        <div class="team-names">
                            <div class="t-card-body ">
                                ...
                                <p class="t-card-text">President of the University of Skikda</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="margin-padding" >
                        ...
                        <div class="team-names">
                            <div class="t-card-body ">
                                ...
                                <p class="t-card-text">Professor at the University of Skikda | CS</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="margin-padding" >
                        ...
                        <div class="team-names">
                            <div class="t-card-body ">
                                ...
                                <p class="t-card-text"> Middle School Student</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="margin-padding" >
                            ...
                            <div class="team-names">
                                <div class="t-card-body ">
                                    ...
                                    <p class="t-card-text">Master 2 CS Student</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="margin-padding" >
                            ...
                            <div class="team-names">
                                <div class="t-card-body ">
                                    ...
                                    <p class="t-card-text">Master 2nd CS Student</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="margin-padding" >
                            ...
                            <div class="team-names">
                                <div class="t-card-body ">
                                    ...
                                    <p class="t-card-text">PhD Student CS</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="margin-padding" >
                            ...
                            <div class="team-names">
                                <div class="t-card-body ">
                                    ...
                                    <p class="t-card-text">Full Stack Web Developer</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="margin-padding" >
                            ...
                            <div class="team-names">
                                <div class="t-card-body ">
                                    ...
                                    <p class="t-card-text">Front-end Web Developer</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="margin-padding" >
                            ...
                            <div class="team-names">
                                <div class="t-card-body ">
                                    ...
                                    <p class="t-card-text"> Web Designer</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="margin-padding" >
                            ...
                            <div class="team-names">
                                <div class="t-card-body ">
                                    ...
                                    <p class="t-card-text"> High School Student</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="team-names">
                                <div class="t-card-body ">
                                    <h5 class="t-card-title ">Serine Sefardjelah<br>
                                        <span class="badge bg-secondary mb-1">Ai Junior</span></h5>
                                    <p class="t-card-text"> Student At Esi Algeirs</p>
                                </div>
                            </div>
                        </div>

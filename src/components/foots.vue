<template>
    ...
    <footer>
        ...
        <div class="container-fluid lastone">
            <div class="row">
                <div class="col-sm-2">
                    <!-- let this empty for holding 2 grids-->
                </div>
                <div class="col-sm-3">
                    <div class="adclas">
                        Address
                    ...
                    <div class="copclas">
                        <!-- add years here    type date   js   -->
                        Copyright 2020 Skailab
                    </div>
                </div>
                <div class="col-sm-1">
                    <!-- let this empty for holding 1 grids-->
                </div>
                <div class="col-sm-6">
                    <div class="row">
                        <div class="col-sm-6">
                    ...
                    <div class="row padd">
                        ...
                        <div class="col-sm-3">
                            <img class="center1" style=" width:150px ; height:150px;" src="../../public/data/img/nokhab.png" alt="Nokhba aimen logo in skailab">
                        </div>
